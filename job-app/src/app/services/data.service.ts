...
export class DataService {
  ...
  //   return this.http.post("http://localhost:3000/jobs/", JSON.stringify(job), options)
  ...
  updateJob(id:string, job:IJob) {
    return this.http.patch("http://localhost:3000/jobs/"+id, job)
    .map(data => data.json()).toPromise();
  }
  ...
  // getJobs() {
  //   return this._http.get("http://localhost:3000/jobs/")
  //   .map(data => data.json()).toPromise();
  // }
